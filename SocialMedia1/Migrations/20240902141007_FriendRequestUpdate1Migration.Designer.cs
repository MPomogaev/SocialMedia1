...
namespace SocialMedia1.Migrations
{
    ...
    [Migration("20240902141007_FriendRequestUpdate1Migration")]
    partial class FriendRequestUpdate1Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMedia1.Models.FriendRequestStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocialMedia1.Models.FriendRequest", b =>
                {
                    b.HasOne("SocialMedia1.Models.Account", "Requested")
                        .WithOne()
                        .HasForeignKey("SocialMedia1.Models.FriendRequest", "RequestedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SocialMedia1.Models.Account", "Requester")
                        .WithMany()
                        .HasForeignKey("RequesterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialMedia1.Models.FriendRequestStatus", "Status")
                        .WithMany()
